...
int main() {
    ...
    for (int s = 0; s < NUM_SAMPLES; s++) {
        ...
        printf("Sample %d (SNR %d): HW Estimates = %.10f, %.10f m/s\n", current->sample_id, current->snr, hw_clipped0, hw_clipped1);
        ...
        // 5. Compare outputs (Relaxed to 0.05 to accommodate the highly efficient fast_atan2f approximation)
